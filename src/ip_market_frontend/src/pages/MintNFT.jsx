 ...
 useEffect(() => {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 bg-white shadow-md rounded-xl p-6">
      <h2 className="text-3xl font-bold mb-6 text-center text-gray-800">Mint New NFT</h2>
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {/* Select IP */}
        <div>
          <label className="block text-sm font-medium text-gray-700">Select Registered IP</label>
          <select
            value={form.ip_id}
